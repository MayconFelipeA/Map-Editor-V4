...
#include "mapedit/update/juiz.pwn"
//------------------------------------------------------------------------------
// Callbacks
...
public OnFilterScriptInit() {
    ...
    if(timertext3d != 0)
    {
        KillTimer(timertext3d);
    }
    timertext3d = SetTimerEx("UpdateText3D", 150, 1, "d", 0);
...
public OnPlayerConnect(playerid) {
    if(!playerid)
    {
        ...
        timertext3d = SetTimerEx("UpdateText3D", 1000, 1, "d", playerid);
    }
